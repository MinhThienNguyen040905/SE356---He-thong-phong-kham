...
async function run() {
    ...
    try {
        ...
        if (doctorCards.length > 0) {
            ...
            await driver.executeScript("document.querySelector('select').value = ''");
        ...
        console.log("AT-204 Passed: add_doctor_schedule_fail_no_shift");
    } catch (err) { 
        console.error("AT-204 Failed:", err.message); 
    } finally { 
        await driver.quit(); 
    }
}
