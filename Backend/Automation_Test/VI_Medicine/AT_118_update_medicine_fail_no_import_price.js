...
async function run() {
    ...
    try {
        ...
        let priceField = await driver.findElement(By.id("importPrice"));
        ...
        console.log("AT-124 Passed: Cập nhật thất bại khi trống giá nhập.");
    } catch (err) {
        console.error("AT-124 Failed:", err.message);
    } finally {
        await driver.quit();
    }
}
