    ...
    try {
        ...
        await driver.sleep(2000);
      
            {
              ...
              await driver.executeScript("arguments[0].click();", selects[selects.length - 1]); // Usually the last combobox
              await driver.sleep(500);
              const opt = await driver.wait(until.elementLocated(By.xpath("//div[@role='option' and contains(., '20 đơn vị')]")), 5000);
        ...
        console.log("AT-192 Passed: filter_medicine_expiry_stock");
    } catch (err) { 
        console.error("AT-192 Failed:", err.message); 
    } finally { 
        await driver.quit(); 
    }
}
