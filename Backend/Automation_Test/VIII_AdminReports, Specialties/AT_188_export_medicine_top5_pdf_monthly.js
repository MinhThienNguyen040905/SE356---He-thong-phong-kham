    ...
    try {
        ...
        await driver.sleep(3000);
        ...
        
          {
            ...
            await driver.executeScript("arguments[0].click();", selects[1]); // Month
        ...
        console.log("AT-188 Passed: export_medicine_top5_pdf_monthly");
    } catch (err) { 
        console.error("AT-188 Failed:", err.message); 
    } finally { 
        await driver.quit(); 
    }
}
