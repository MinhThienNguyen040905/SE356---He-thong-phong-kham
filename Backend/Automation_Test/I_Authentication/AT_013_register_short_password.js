...
async function run() {
    ...
    try {
        ...
        await driver.wait(until.elementLocated(By.name("password")), 5000).sendKeys("123");
        await driver.findElement(By.name("confirmPassword")).sendKeys("123");
        await driver.findElement(By.id("terms")).click();
        await driver.findElement(By.xpath("//button[@type='submit']")).click();
        await driver.wait(until.elementLocated(By.xpath("//p[contains(text(), 'ký tự')]")), 3000);
        console.log("AT-013 Passed");
